...
namespace JewelsExchange.iOS
{
	...
	public class IncomingCell : BubbleCell
	{
		...
		void Initialize ()
		{
			...
			//var msgLeading1 = NSLayoutConstraint.Create(AudioDownloadButton, NSLayoutAttribute.Leading, NSLayoutRelation.GreaterThanOrEqual, BubbleImageView, NSLayoutAttribute.Leading, 1, 16);
			//ContentView.AddConstraint(msgLeading1);
			...
			var msgCenter1 = NSLayoutConstraint.Create(AudioPlayButton, NSLayoutAttribute.CenterX, NSLayoutRelation.Equal, BubbleImageView, NSLayoutAttribute.CenterX, 1, 45);//
			...
			//var msgLeading3 = NSLayoutConstraint.Create(AudioStopButton, NSLayoutAttribute.Leading, NSLayoutRelation.GreaterThanOrEqual, BubbleImageView, NSLayoutAttribute.Leading, 1, 16);
			//ContentView.AddConstraint(msgLeading3);
			...
			var msgCenteri = NSLayoutConstraint.Create(ImageAttachment, NSLayoutAttribute.CenterX, NSLayoutRelation.Equal, BubbleImageView, NSLayoutAttribute.CenterX, 1, 45);
